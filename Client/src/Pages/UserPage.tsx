...
const UserPage = () => {
    ...
    useEffect(() => {
        const getCustomUser = async (): Promise<CustomUser> => {
            const response = await axios.get(`http://localhost:8080/api/users/${id}`).then((response) => {
                ...
                (
                    <div className="user-page-main">
                            ...
                            <div className='user-page-main-left-info'>
                                <div className='user-page-main-left-info-avatar'>
                                    ...
                                    <button className='overlay-btn'>
                                        ...
                                        >
                                            <UserAvatar alt={customUser?.email} src={customUser?.avatar} />
                                        </Badge>
                                        <img src='https://img.icons8.com/ios-glyphs/30/000000/camera.png' alt='Change picture' className='overlay-pic' />
                                    </button>
                                    :
                                    <button className='overlay-btn'>
                                        <UserAvatar alt={customUser?.email} src={customUser?.avatar} />
                        ...
                        <div className='user-page-main-right'>
                            <PersonalDataForm customUser={customUser} setCustomUser={setCustomUser} />
                        </div>
                    </div>
                ) 
                : 
